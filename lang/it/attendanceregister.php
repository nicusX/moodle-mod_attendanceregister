...
// Alert
$string['standardlog_disabled'] = 'Moodle Standard Log � disabilitato. Tutte le nuove sessioni degli utenti non sono tracciate';
$string['standardlog_readonly'] = 'Moodle Standard Log � sola lettura. Tutte le nuove sessioni degli utenti non sono tracciate ';
