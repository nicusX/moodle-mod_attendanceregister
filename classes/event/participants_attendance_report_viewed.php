...
/*    public static function get_name() {
    ...
    public function get_legacy_logdata() {
        ...
        return array($this->courseid, 'attendanceregister', 'view_user_attendance_details', 'view.php?id='. $this->contextinstanceid .'&user='.$this->userid, $this->objectid, $this->contextinstanceid);
    }
