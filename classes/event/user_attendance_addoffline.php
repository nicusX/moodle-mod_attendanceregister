...
/*    public static function get_name() {
    ...
    public function get_legacy_logdata() {
        ...
        return array($this->courseid, 'attendanceregister', 'user_attendance_addoffline', 'view.php?id='. $this->contextinstanceid .'&user='.$this->userid, $this->objectid, $this->contextinstanceid);
    }
